...
function FeeVouchar() {
    ...
    document.title = "GCUF | Students | Feevoucher ";
                        ...
                        <div className="fee-voucher">
                            <header className="header mb-2">
                                <div className="title-container flex-center">
                                    <img className='me-2' src={Logo} alt="logo gcuf" width={40} />
                                    <p style={{ fontSize: "12px", textDecorationLine: "underline" }}> G.C. University Faisalabad <br /> </p>
                                ...
                                <div className="student-info">
                                    <table className='table table-bordered border-2 border-dark'>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="2">Name:M. Abu bakkar</td>
                                            </tr>
                                            <tr >
                    ...
                    <Col sm={3} className='border p-1 bg-white' >
                        <div className="fee-voucher">
                            <header className="header mb-2">
                                <div className="title-container flex-center">
                                    <img className='me-2' src={Logo} alt="logo gcuf" width={40} />
                                    <p style={{ fontSize: "12px", textDecorationLine: "underline" }}>Fee Voucher For Spring. 2024 <br /> G.C. University Faisalabad</p>
                                </div>
                            ...
                            <main className="main">
                                <div className="voucher-info">
                                    ...
                                    <p><span className='fw-bold'>Campus Name:</span><span className='underlineText'>Main Campous</span> </p>
                                ...
                                <div className="student-info">
                                    <p><span className='fw-bold'>Student Name:</span><span className='underlineText'>MUHAMMAD ABU BAKKAR</span> </p>
                                    <p><span className='fw-bold'>Father Name:</span><span className='underlineText'>MUKHTAR AHMAD</span> </p>
                                    ...
                                    <p><span className='fw-bold'>Session:</span><span className='underlineText'>2020-2024</span> </p>
                                    <h2> </h2>
                                    <p> </p>
                                    <p> 4150</p>
                                    <p> 38405-2613973-9</p>
